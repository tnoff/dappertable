...
- Bumped wcwidth to v0.8.2

## [1.1.4] - 2026-05-10

### Changed
- Source tarballs attached to GitLab Releases now contain only the runnable package plus install metadata (`LICENSE`, `pyproject.toml`, `VERSION`); tests, CI configs, and top-level docs are excluded via `.gitattributes`
...
### Changed
- Migrated CI from GitHub Actions to GitLab CI
- Added bandit security scanning to tox test suite
- Configured Renovate for pip and GitLab CI dependency updates
- Dropped Python 3.10 from test matrix
